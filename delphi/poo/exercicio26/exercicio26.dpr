...
//Crie uma classe chamada TCalculadora que tenha métodos de classe para realizar operações
//matemáticas básicas: soma, subtração, multiplicação e divisão. Cada método deve receber
//dois números como parâmetros e retornar o resultado.
...
begin
  num1 := 5;
  num2 := 10;
  writeln('Número 1 = ' , num1:0:2 , ' | Número 2 = ' , num2:0:2);

  try
    writeln('Soma = ' , TCalculadora.soma(num1,num2):0:2);
    writeln('Subtracao: ' , TCalculadora.subtracao(num1,num2):0:2);
    writeln('Multiplicação = ' , TCalculadora.multiplicacao(num1,num2):0:2);
    writeln('Divisão = ' , TCalculadora.divisao(num1,num2):0:2);
  finally
